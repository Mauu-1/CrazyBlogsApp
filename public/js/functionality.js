...
//         // Asegúrate de que solo el enlace clickeado tenga la clase 'navElement'
//         $('a.nav-link').removeClass('navElement');
//         $(this).addClass("navElement");
//     });
// });
...
$(function(){
    $(".delete").on("click", function(){
       ...
       const element = $(this.parentElement.parentElement.parentElement.parentElement);
...
// $(function myFunction() {
//     $('.creation').on("click", function(){
//         $(function(){window.location.href = "http://localhost:3000/blog"
//         $()
...
//         console.log("sucess");
    ...
    //         $("div.solution_cards_box").html(`<div class="solution_card">
...
//     $("a.nav-link").on("click", function() { 
//         if ($(this).hasClass("navElement")) {
//             console.log("success");
//         } else {
//             // Quita la clase 'navElement' de todos los otros enlaces antes de añadirlo al actual
//             $('a.nav-link').removeClass('navElement');
//             $(this).addClass("navElement");
//         }
//     });
